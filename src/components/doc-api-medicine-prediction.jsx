                      ...
                      <ul className="list-unstyled nav-sidebar">
                        ...
                        <li className="nav-item active">
                          ...
                          >
                            ...
                            <li>
                              <Link className="nav-link active" to="/mp">
                                Medicine Prediction
                              </Link>
                            </li>
                            <li>
                    ...
                    <tbody>
                      ...
                      >
                        ...
                        >
                          <div className="markdown">
                            <p>
                              Id of Medicine prediction, get it from Medicine
                              prediction List API to delete the information by
                              id
                            </p>
                          </div>
                          <input
                    ...
                    >
                      ...
                      >
                        ...
                        <nav
                          ...
                          id="navbar-example3"
                        >
                          <a href="#api-get-medicine-prediction" className="nav-link">
                            GET 
                          </a>
                          <a href="#api-post-medicine-prediction" className="nav-link">
                            POST
                          </a>
                          <a href="#api-delete-medicine-prediction" className="nav-link">
                            DELETE
                          </a>
                        </nav>
                      </div>
