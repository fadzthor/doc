                    ...
                    <ul className="list-unstyled nav-sidebar">
                      ...
                      <li className="nav-item active">
                        ...
                        >
                          ...
                          <li>
                          <Link className="nav-link active" to="/w" >
                              Warehouse
                              </Link>
                          </li>
                          <li>
                  ...
                  >
                    ...
                    >
                      ...
                      <nav
                        ...
                        id="navbar-example3"
                      >
                        <a href="#api-get-warehouse" className="nav-link">
                        List Warehouse
                        </a>
                        <a href="#api-post-warehouse" className="nav-link">
                        Create Warehouse
                        </a>
                        <a href="#api-get-detail-warehouse" className="nav-link">
                        Detail Warehouse
                        </a>
                        <a href="#api-delete-warehouse" className="nav-link">
                        Delete Warehouse
                        </a>
                        <a href="#api-patch-warehouse" className="nav-link">
                        Update Warehouse
                        </a>
                      </nav>
                    </div>
