  ...
  return (
    ...
    >
      ...
      <article className="documentation_body" id="api-get-patient">
        ...
        <p>Menampilkan daftar semua pasien.</p>
        ...
        <table className="table table-bordered">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <div>untuk memberikan nama pasien</div>
                <div>
                  <input
                    type="text"
                    className
      ...
      <article className="documentation_body" id="api-post-patient">
        ...
        <p>
        API ini untuk membuat data pasien dan akan ditampilkan di
          Daftar pasien.
        </p>
        ...
        <table className="table table-bordered">
          ...
          <tbody>
            <tr>
              ...
              <td>
                <div>untuk menampilkan deskripsi Muatan Pasien</div>
                <div>
                  <pre className=" language-html">
                    <code className=" language-html" data-lang="html">
                      {"["}
      ...
      <article className="documentation_body" id="api-delete-patient">
        ...
        <p>
        API ini untuk menghapus data pasien. Ini tidak bisa dihapus jika
          beberapa pasien menggunakan unit ini.
        </p>
        ...
        <table className="table table-bordered">
          ...
          <tbody>
            <tr>
              ...
              <td>
                <div>
                Id Pasien, dapatkan dari API Daftar Pasien ke
                  perbarui informasi dengan id
                </div>
                <div>
                  <input
                    type="text"
      ...
      <article className="documentation_body" id="api-patch-patient">
        ...
        <p>
        API ini untuk memperbarui data pasien dan akan diganti yang lama
          informasi pasien dengan input baru Anda, Anda harus mendapatkan
          id data yang ingin Anda ubah, Tekan API Daftar Pasien untuk
          mendapatkan.
        </p>
