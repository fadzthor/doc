        ...
        <div id="post" className="documentation_info rvfs-4" data-rvfs={4}>
          <article className="documentation_body" id="documentation">
            <div className="shortcode_title">
              ...
              <p>Medicine mutation merupakan sebuah proses memasukkan
                dan mengeluarkan jumlah obat di apotek baik yang berkaitan
                dengan transaksi maupun tidak.
              </p>
            </div>
            <div className="border_bottom" />
          </article>
          <article className="documentation_body" id="api-get-medicine-mutation">
          <h4 className="c_head"><span className="badge bg-info ml-1">GET</span>/medicine-mutation medicine mutation list</h4>
            <div className="highlight">
              <div className="code-toolbar"><pre className=" language-htmlasc"><code className=" language-htmlasc" data-lang="html">http://103.228.245.122:3033/medicine-mutation</code></pre><div className="toolbar"><div className="toolbar-item"><span>Htmlasc</span></div><div className="toolbar-item"><button>Copy</button></div></div></div>
            </div>
          ...
          <article className="documentation_body" id="api-post-medicine-mutation">
          <h4 className="c_head"><span className="badge bg-success ml-1">POST</span>/medicine-mutation create medicine mutation</h4>
            <div className="highlight">
              <div className="code-toolbar"><pre className=" language-htmlasc"><code className=" language-htmlasc" data-lang="html">http://103.228.245.122:3033/medicine-mutation</code></pre><div className="toolbar"><div className="toolbar-item"><span>Htmlasc</span></div><div className="toolbar-item"><button>Copy</button></div></div></div>
            </div>
            <p>This API is used for medicine transaction between warehouse. A lot of validation here. Please don't add data directly in database, use this Api instead or you will break the system rule.</p>
