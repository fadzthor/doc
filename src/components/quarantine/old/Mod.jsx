const Mud = () => {
          ...
          <div className="row">
            ...
            <div className="col-lg-7 col-md-8">
              <div
                ...
                data-rvfs={4}
              >
                <article className="documentation_body" id="medicine-out-detail">
                ...
                <article className="documentation_body" id="post-mod">
                  <h4 className="c_head">
  ...
  <div className="parameters-container">
    <div className="table-container">
      <table className="parameters" style={{ width: 490 }} border="1px">
        <thead>
          <tr>
            <th
        ...
        <tbody>
          <tr data-param-name="payload" data-param-in="body">
            <td className="parameters-col_name" style={{ width: "71.7031px" }}>
              <div className="parameter__name required">
                {/* react-text: 1443 */}payload{/* /react-text */}&nbsp;*
              </div>
              <div className="parameter__type">
                {/* react-text: 1446 */}object{/* /react-text */}
              </div>
              <div className="parameter__deprecated">&nbsp;</div>
              <div className="parameter__in">
                {/* react-text: 1449 */}({/* /react-text */}
                {/* react-text: 1450 */}body{/* /react-text */}
                      ...
                      >
                        ...
                        >
                          ...
                          <span className="hljs-attr">
                            {/* react-text: 1605 */}"amount"{/* /react-text */}
                          </span>
                          {/* react-text: 1607 */}: {/* /react-text */}
                          <span style={{ color: "#d36363" }}>
                            {/* react-text: 1609 */}200{/* /react-text */}
                          </span>
                          {/* react-text: 1611 */},{"\n"}
                          {/* /react-text */}
                          {/* react-text: 1613 */}
                          ...
                          {/* /react-text */}
                          <span className="hljs-attr">
                            {/* react-text: 1615 */}"medicine_id"
                            {/* /react-text */}
                          </span>
                          {/* react-text: 1617 */}: {/* /react-text */}
                          <span style={{ color: "#d36363" }}>
                            {/* react-text: 1619 */}1{/* /react-text */}
                          </span>
                          {/* react-text: 1621 */},{"\n"}
                          {/* /react-text */}
                          {/* react-text: 1623 */}
                          ...
                          {/* /react-text */}
                          <span className="hljs-attr">
                            {/* react-text: 1625 */}"medicine_out_header_id"
                            {/* /react-text */}
                          </span>
                          {/* react-text: 1627 */}: {/* /react-text */}
                          <span style={{ color: "#d36363" }}>
                            {/* react-text: 1629 */}1{/* /react-text */}
                          </span>
                          {/* react-text: 1631 */}
                          {"\n"}
                          {/* /react-text */}
  ...
  <tbody>
    <tr style={{ height: 161 }} data-param-name="id" data-param-in="path">
      ...
      >
        <div className="markdown">
          <p>
          Id of Medicine Out Detail, get it from Medicine Out Header List API to delete the information by id
          </p>
        </div>
        <input
          className=""
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          <a href="#post-mod" className="nav-link active">
                            POST
                          </a>
