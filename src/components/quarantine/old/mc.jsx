              ...
              <ul className="list-unstyled nav-sidebar">
                ...
                <li className="nav-item">
                  <a target="_blank" download rel="noreferrer" href="http://yoviealfaguistuta.site/" className="nav-link"><img src="https://football-team-management.spaceart.tech/img/side-nav/coding.png" alt="" className="mCS_img_loaded" />Portofolio</a>
                      ...
                      <li><a href="https://football-team-management.spaceart.tech/api-docs/studi-kasus">Studi Kasus</a>medicine</li>
                ...
                <ul className="list-unstyled nav-sidebar">
                  ...
                  <li className="nav-item active">
                    ...
                    <ul className="list-unstyled dropdown_nav" style={{display: 'block'}}>
                      ...
                      <li><a href="https://football-team-management.spaceart.tech/api-docs/tim">Medicine Out Detail</a></li>
                      <li><a href="https://football-team-management.spaceart.tech/api-docs/pemain">Medicine Out Header</a></li>
                      <li><a href="https://football-team-management.spaceart.tech/api-docs/jadwal-pertandingan">Medicine Prediction</a></li>
                      <li><a href="https://football-team-management.spaceart.tech/api-docs/hasil-pertandingan">Medicine Request</a></li>
                      <li><a href="https://football-team-management.spaceart.tech/api-docs/report">Medicine Stock</a></li>
        ...
        <div id="post" className="documentation_info rvfs-4" data-rvfs={4}>
          <article className="documentation_body" id="documentation">
            <div className="shortcode_title">
              ...
              <p>dengan mengenal kategori obat dapat meningkatkan 
                kewaspadaan dalam mengonsumsi dan memberikan obat.
              </p>
            </div>
            <div className="border_bottom" />
          </article>
          <article className="documentation_body" id="api-get-medicine-category">
            <h4 className="c_head"><span className="badge bg-success ml-1">GET</span>/medicine-category medicine category list</h4>
            <div className="highlight">
              <div className="code-toolbar"><pre className=" language-htmlasc"><code className=" language-htmlasc" data-lang="html">http://103.228.245.122:3033/medicine-category</code></pre><div className="toolbar"><div className="toolbar-item"><span>Htmlasc</span></div><div className="toolbar-item"><button>Copy</button></div></div></div>
            </div>
            <p>Showing list of all medicine category. Medicine category is used to determine the form or type of medicine.</p>
          ...
          <article className="documentation_body" id="api-post-medicine-category">
            <h4 className="c_head"><span className="badge bg-info ml-1">POST</span>/medicine-category create medicine category</h4>
            <div className="highlight">
              <div className="code-toolbar"><pre className=" language-htmlasc"><code className=" language-htmlasc" data-lang="html">http://103.228.245.122:3033/medicine-category</code></pre><div className="toolbar"><div className="toolbar-item"><span>Htmlasc</span></div><div className="toolbar-item"><button>Copy</button></div></div></div>
            </div>
            <p>This API for create medicine category data and will be showed up on Medicine Category List.</p>
            <table className="table table-bordered">
                        <thead>
                          <tr>
                            <th>Name</th>
          ...
          <article className="documentation_body" id="api-delete-medicine-category">
            <h4 className="c_head"><span className="badge bg-danger ml-1">DELETE</span>/medicine-category/(id) delete medicine category</h4>
            <div className="highlight">
              <div className="code-toolbar"><pre className=" language-htmlasc"><code className=" language-htmlasc" data-lang="html">http://103.228.245.122:3033/medicine-category/2</code></pre><div className="toolbar"><div className="toolbar-item"><span>Htmlasc</span></div><div className="toolbar-item"><button>Copy</button></div></div></div>
            </div>
            <p>This API for delete medicine category data, You have to get the id of the data you want to delete, Hit Medicine Category List API to get it.</p>
            <table className="table table-bordered">
                        <thead>
                          <tr>
                            <th>Name</th>
                        ...
                        <td>
                          <div>Id of Medicine Category, get it from Medicine Category List API to delete the data by id</div>
                          <input type="text" class="" title="" placeholder="id" value=""/>
                        </td>
                          </tr>
                        </tbody>
                      </table>
            <div className="multi-collapse collapse" id="HNHqtY5fBq" style={{}}>
              <div className="card card-body toggle_body"> 
                <div className="highlight">
                  <div className="code-toolbar"><pre className=" language-html"><code className=" language-html" data-lang="html">{"{"}<span className="token lf">{"\n"}</span><span className="token space"> </span><span className="token space"> </span><span className="token space"> </span><span className="token space"> </span>"body":<span className="token space"> </span>1,<span className="token lf">{"\n"}</span><span className="token space"> </span><span className="token space"> </span><span className="token space"> </span><span className="token space"> </span>"status":<span className="token space"> </span>true,<span className="token lf">{"\n"}</span><span className="token space"> </span><span className="token space"> </span><span className="token space"> </span><span className="token space"> </span>"__type":<span className="token space"> </span>"string"<span className="token lf">{"\n"}</span>{"}"}</code></pre><div className="toolbar"><div className="toolbar-item"><span>HTML</span></div><div className="toolbar-item"><button>Copy</button></div></div></div>
                </div>
              </div>
            </div>
            <div className="border_bottom mt-5" />
          ...
          <article className="documentation_body" id="api-patch-medicine-category">
            <h4 className="c_head"><span className="badge bg-info ml-1">PATCH</span>/medicine-category/(id) update medicine category</h4>
            <div className="highlight">
              <div className="code-toolbar"><pre className=" language-htmlasc"><code className=" language-htmlasc" data-lang="html">http://103.228.245.122:3033/medicine-category/2</code></pre><div className="toolbar"><div className="toolbar-item"><span>Htmlasc</span></div><div className="toolbar-item"><button>Copy</button></div></div></div>
            </div>
            <p>This API for update medicine category data and will be replaced old medicine information with your new input, You have to get the id of the data you want to change, Hit Medicine Category List API to get it.</p>
            <table className="table table-bordered">
                        <thead>
                          <tr>
                            <th>Name</th>
                        ...
                        <td>
                          <div>Id of Medicine Category, get it from Medicine Category List API to update the information by id</div>
                          <input type="text" class="" title="" placeholder="id" value=""/>
                        </td>
                          </tr>
                          <tr>
            ...
            <div className="collapse multi-collapse" id="jQ2bC3wnEH">
              <div className="card card-body toggle_body"> 
                <div className="highlight">
                  <div className="code-toolbar"><pre className=" language-html"><code className=" language-html" data-lang="html">{"{"}<span className="token lf">{"\n"}</span><span className="token space"> </span><span className="token space"> </span><span className="token space"> </span><span className="token space"> </span>"body":<span className="token space"> </span>1,<span className="token lf">{"\n"}</span><span className="token space"> </span><span className="token space"> </span><span className="token space"> </span><span className="token space"> </span>"status":<span className="token space"> </span>true,<span className="token lf">{"\n"}</span><span className="token space"> </span><span className="token space"> </span><span className="token space"> </span><span className="token space"> </span>"__type":<span className="token space"> </span>"updatemedicinecategory"<span className="token lf">{"\n"}</span>{"}"}</code></pre><div className="toolbar"><div className="toolbar-item"><span>HTML</span></div><div className="toolbar-item"><button>Copy</button></div></div></div>
                </div>
              </div>
            </div>
            <div className="border_bottom mt-5" />
