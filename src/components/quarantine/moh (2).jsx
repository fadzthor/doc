            ...
            <div className="col-lg-7 col-md-8">
              ...
              >
                        ...
                        <div className="code-toolbar">
                          <pre className=" language-html">
                            ...
                            "ListMedicineOutHeader"
                              ...
                              <span className="token space"></span>
                              <span className="token space"></span>
                              <span className="token space"></span>"current_page":
                              <span className="token space"></span>1,
                              <span className="token lf">{"\n"}</span>
                              <span className="token space"></span>
                              <span className="token space"> </span>
                        ...
                        <div className="code-toolbar">
                          <pre className=" language-html">
                            <code className=" language-html" data-lang="html">
                              ...
                              <span className="token space"> </span>
                              <span className="token space"></span>
                              <span className="token space"> </span> access-control-allow-origin:
                              <span className="token space"></span>
                            *
                              <span className="token lf">{"\n"}</span>
                              <span className="token space"> </span>
                              ...
                              <span className="token space"></span>
                              <span className="token space"> </span>
                              <span className="token space"></span>content-length: 
                              ...
                              <span className="token space"></span>
                              <span className="token space"></span>
                              <span className="token space"></span> content-type: 
                              <span className="token space"></span>
                              application/json 
                              <span className="token lf">{"\n"}</span>
                              <span className="token space"></span>
                              ...
                              <span className="token space"></span> Tue,11 Oct 2022 06:17:06 GMT 
                              <span className="token lf">{"\n"}</span>
                              <span className="token space"></span>
                              <span className="token space"> </span>
                              <span className="token space"></span>
                ...
                <article className="documentation_body" id="create">
                  ...
                  <div className="highlight">
                    <p> API ini untuk membuat data header obat keluar dan akan ditampilkan di API Daftar Header Obat Keluar,<br></br> 
                   Anda dapat membawa larik Detail Obat Keluar untuk terhubung dengan Header ini</p>
                    <div className="code-toolbar">
                      <pre className=" language-htmlasc">
                        <code className=" language-htmlasc" data-lang="html">
                        'http://103.228.245.122:3033/medicine-out-header
                  ...
                  <p>membuat dan Menampilkan data transaksi obat pada out Header</p>
        ...
        <tr data-param-name="payload" data-param-in="body">
          <td className="parameters-col_name">
            <div className="parameter__name required">
              {/* react-text: 1542 */}payload{/* /react-text */}
              <span>&nbsp;*</span>
            </div>
            <div className="parameter__type">
              {/* react-text: 1545 */}object{/* /react-text */}
            </div>
            <div className="parameter__deprecated" />
          ...
          <td className="parameters-col_description">
            ...
            <div className="model-example">
              ...
              <div>
                    ...
                    >
                      ...
                      >
                        ...
                        <span className="hljs-attr">
                          {/* react-text: 1731 */}"complaint"{/* /react-text */}
                        </span>
                        <span>
                          {/* react-text: 1733 */}: {/* /react-text */}
                        </span>
                        <span style={{ color: "rgb(162, 252, 162)" }}>
                          {/* react-text: 1735 */}"Sakit perut dan sakit kepala
                          sebelah"{/* /react-text */}
                        </span>
                        <span>
                          {/* react-text: 1737 */},{"\n"}
                        ...
                        <span className="hljs-attr">
                          {/* react-text: 1741 */}"diagnosis"{/* /react-text */}
                        </span>
                        <span>
                          {/* react-text: 1743 */}: {/* /react-text */}
                        </span>
                        <span style={{ color: "rgb(162, 252, 162)" }}>
                          {/* react-text: 1745 */}"HIV"{/* /react-text */}
                        </span>
                        <span>
                          {/* react-text: 1747 */},{"\n"}
                          {/* /react-text */}
                        ...
                        <span className="hljs-attr">
                          {/* react-text: 1751 */}"medicine"{/* /react-text */}
                        </span>
                        <span>
                          {/* react-text: 1753 */}: [{"\n"}
                          {/* /react-text */}
                        ...
                        <span className="hljs-attr">
                          {/* react-text: 1758 */}"amount"{/* /react-text */}
                        </span>
                        <span>
                          {/* react-text: 1760 */}: {/* /react-text */}
                        </span>
                        <span style={{ color: "rgb(211, 99, 99)" }}>
                          {/* react-text: 1762 */}200{/* /react-text */}
                        </span>
                        <span>
                          {/* react-text: 1764 */},{"\n"}
                          {/* /react-text */}
                        ...
                        <span className="hljs-attr">
                          {/* react-text: 1768 */}"medicine_id"
                          {/* /react-text */}
                        </span>
                        <span>
                          {/* react-text: 1770 */}: {/* /react-text */}
                        </span>
                        <span style={{ color: "rgb(211, 99, 99)" }}>
                          {/* react-text: 1772 */}1{/* /react-text */}
                        </span>
                        <span>
                          {/* react-text: 1774 */}
                          {"\n"}
                        ...
                        <span>
                          {/* react-text: 1782 */}: {/* /react-text */}
                        </span>
                        <span style={{ color: "rgb(211, 99, 99)" }}>
                          {/* react-text: 1784 */}1{/* /react-text */}
                        </span>
                        <span>
                          {/* react-text: 1786 */}
                          {"\n"}
                        ...
                        <div className="code-toolbar">
                          <pre className=" language-html">
                            <code className=" language-html" data-lang="html">
                              ...
                              <span className="token space"> </span>
                              <span className="token space"> </span>"complaint":
                              <span className="token space"> </span>"Sakit perut dan 
                              <span className="token space"> </span>Sakit kepala sebelah",
                              <span className="token lf">{"\n"}</span>
                              <span className="token space"> </span>
                              <span className="token space"> </span>
                              <span className="token space"> </span>
                        ...
                        <div className="code-toolbar">
                          <pre className=" language-html">
                            <code className=" language-html" data-lang="html">
                              ...
                              "message":
                              <span className="token space"> </span>
                              "oops!.. Hanya pengguna yang berada 
                              di Gudang Penjualan
                               yang dapat mengeluarkan atau menjual obat"
                              <span className="token lf">{"\n"}</span>
                              <span className="token space"> </span>
                              <span className="token space"> </span>
                              <span className="token space"> </span>
                              ...
                              <span className="token space"> </span>
                              <span className="token space"> </span>"__typename":
                              <span className="token space"> </span> "CreateMedicineOutHeader",
                             <span className="token lf">{"\n"}</span>
                              <span className="token space"> </span>
                              <span className="token space"> </span>
                              <span className="token space"> </span>
                        ...
                        <div className="code-toolbar">
                          <pre className=" language-html">
                            ...
                            *
                              ...
                              <span className="token space"></span>
                              <span className="token space"></span> date:
                              <span className="token space"></span> Tue,11 Oct 2022 09:28:09 GMT 
                              <span className="token lf">{"\n"}</span>
                              <span className="token space"></span>
                              <span className="token space"> </span>
                              <span className="token space"></span>
                ...
                <article className="documentation_body" id="update">
                  <h4 className="c_head">
                    <span className="badge bg-success ml-6">GET</span>/ medicine -out-header / {"{"} id {"}"}
                  </h4>
                  <div className="highlight">
                  API ini digunakan untuk melihat detail data header obat keluar berdasarkan id-nya.<br></br> 
                  ...
                  <p>
                    melihat detail data obat yang ada di header 
                  </p>
  ...
  <tbody>
    <tr style={{ height: 161 }} data-param-name="id" data-param-in="path">
      ...
      >
        <div className="markdown">
          <p>
            Id of Medicine Out Header, get it from Medicine Out Header List API
        ...
        />
                ...
                <article className="documentation_body" id="delete">
                  <h4 className="c_head">
                    <span className="badge bg-danger ml-1">DELETE</span>/medicine -out-header-/ {"{"} id{"}"}
                  </h4>
                  <div className="highlight">
                    <p>API ini untuk menghapus header obat dengan id-nya.<br></br>
                       Stok obat akan kembali ke gudang saat data ini dihapus.</p>
                    <div className="code-toolbar">
                      <pre className=" language-htmlasc">
                        <code className=" language-htmlasc" data-lang="html">
    ...
    <tr style={{ height: 161 }} data-param-name="id" data-param-in="path">
      ...
      >
        ...
        />
                  ...
                  <article className="documentation_body" id="patch">
                  <h4 className="c_head">
                    <span className="badge bg-succes ml-1">PATCH</span>/medicine -out-header-/ {"{"} id{"}"}
                  </h4>
                  <div className="highlight">
                    <p>API ini untuk memperbarui informasi obat keluar header dengan id-nya dan <br></br>
                      akan menggantikan informasi terakhir dengan input Anda.<br></br>
                       Ada beberapa validasi Anda tidak bisa begitu saja memanipulasi stok obat dengan input Anda.<br></br>
                       Stok obat akan terhubung dengan API ini.</p>
                    <div className="code-toolbar">
                      <pre className=" language-htmlasc">
                        <code className=" language-htmlasc" data-lang="html">
        ...
        <tbody>
          <tr data-param-name="id" data-param-in="path">
            <td className="parameters-col_name">
              ...
              <div className="parameter__type">
                {/* react-text: 3913 */}integer{/* /react-text */}
              </div>
              <div className="parameter__deprecated">&nbsp;</div>
              <div className="parameter__in">
                {/* react-text: 3916 */}({/* /react-text */}
                {/* react-text: 3917 */}path{/* /react-text */}
            ...
            <td className="parameters-col_description">
              <div className="markdown">
                <p>
                  Id of Medicine Out Header, get it from Medicine Out Header
                  List API to update the information by id
                </p>
              </div>
              <input
                className=""
          ...
          <tr data-param-name="payload" data-param-in="body">
            <td className="parameters-col_name">
              <div className="parameter__name required">
                {/* react-text: 3925 */}payload{/* /react-text */}&nbsp;*
              </div>
              <div className="parameter__type">
                {/* react-text: 3928 */}object{/* /react-text */}
              </div>
              <div className="parameter__deprecated">&nbsp;</div>
              <div className="parameter__in">
                {/* react-text: 3931 */}({/* /react-text */}
                {/* react-text: 3932 */}body{/* /react-text */}
                    ...
                    <div className="highlight-code">
                      ...
                      >
                        ...
                        >
                          ...
                          {/* /react-text */}
                          <span className="hljs-attr">
                            {/* react-text: 4081 */}"complaint"
                            {/* /react-text */}
                          </span>
                          {/* react-text: 4083 */}: {/* /react-text */}
                          <span style={{ color: "#a2fca2" }}>
                            {/* react-text: 4085 */}"Sakit perut dan sakit
                            kepala sebelah"{/* /react-text */}
                          </span>
                          {/* react-text: 4087 */},{"\n"}
                          {/* /react-text */}
                          {/* react-text: 4089 */}
                          ...
                          {/* /react-text */}
                          <span className="hljs-attr">
                            {/* react-text: 4091 */}"diagnosis"
                            {/* /react-text */}
                          </span>
                          {/* react-text: 4093 */}: {/* /react-text */}
                          <span style={{ color: "#a2fca2" }}>
                            {/* react-text: 4095 */}"HIV"{/* /react-text */}
                          </span>
                          {/* react-text: 4097 */},{"\n"}
                          {/* /react-text */}
                          {/* react-text: 4099 */}
                          ...
                          {/* /react-text */}
                          <span className="hljs-attr">
                            {/* react-text: 4108 */}"amount"{/* /react-text */}
                          </span>
                          {/* react-text: 4110 */}: {/* /react-text */}
                          <span style={{ color: "#d36363" }}>
                            {/* react-text: 4112 */}200{/* /react-text */}
                          </span>
                          {/* react-text: 4114 */},{"\n"}
                          {/* /react-text */}
                          {/* react-text: 4116 */}
                          ...
                          {/* /react-text */}
                          <span className="hljs-attr">
                            {/* react-text: 4118 */}"id"{/* /react-text */}
                          </span>
                          {/* react-text: 4120 */}: {/* /react-text */}
                          <span style={{ color: "#d36363" }}>
                            {/* react-text: 4122 */}1{/* /react-text */}
                          </span>
                          {/* react-text: 4124 */},{"\n"}
                          {/* /react-text */}
                          {/* react-text: 4126 */}
                          ...
                          {/* /react-text */}
                          <span className="hljs-attr">
                            {/* react-text: 4128 */}"medicine_id"
                            {/* /react-text */}
                          </span>
                          {/* react-text: 4130 */}: {/* /react-text */}
                          <span style={{ color: "#d36363" }}>
                            {/* react-text: 4132 */}1{/* /react-text */}
                          </span>
                          {/* react-text: 4134 */}
                          {"\n"}
                          {/* /react-text */}
                          ...
                          {/* /react-text */}
                          <span className="hljs-attr">
                            {/* react-text: 4140 */}"patient_id"
                            {/* /react-text */}
                          </span>
                          {/* react-text: 4142 */}: {/* /react-text */}
                          <span style={{ color: "#d36363" }}>
                            {/* react-text: 4144 */}1{/* /react-text */}
                          </span>
                          {/* react-text: 4146 */}
                          {"\n"}
                          {/* /react-text */}
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          ...
                          <a href="#patch" className="nav-link">
                            PATCH
                          </a>
                        </nav>
                      </div>
