      ...
      <div className="col-lg-7 col-md-8">
        <div id="post" className="documentation_info rvfs-4" data-rvfs={4}>
          ...
          <article className="documentation_body" id="api-get-medicine">
            <h4 className="c_head"><span className="badge bg-success ml-1">GET</span>/medicine medicine list</h4>
            <div className="highlight">
              <div className="code-toolbar"><pre className=" language-htmlasc"><code className=" language-htmlasc" data-lang="html">http://103.228.245.122:3033/medicine</code></pre><div className="toolbar"><div className="toolbar-item"><span>Htmlasc</span></div><div className="toolbar-item"><button>Copy</button></div></div></div>
            </div>
            <p>
              Showing list of all medicine.
            </p>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <input type="text" class="" title="" placeholder="medicine_name" value=""/>
                        </td>
                        </tr>
                        <tr>
                        <td>
                        ...
                        <td>
                          ...
                          <input type="text" class="" title="" placeholder="start_medicine_price" value=""/>
                        </td>
                        </tr>
                        <tr>
                        <td>
                        ...
                        <td>
                          ...
                          <input type="text" class="" title="" placeholder="end_medicine_price" value=""/>
                        </td>
                        </tr>
                        <tr>
                        <td>
                        ...
                        <td>
                          ...
                          <input type="text" class="" title="" placeholder="category_id" value=""/>
                        </td>
                        </tr>
                        <tr>
                        <td>
                        ...
                        <td>
                          ...
                          <input type="text" class="" title="" placeholder="unit_id" value=""/>
                        </td>
                        </tr>
                    </tbody>
                  </table>
                        ...
                        <div className="code-toolbar">
                          <pre className=" language-html">
                            <code className=" language-html" data-lang="html">
                              ...
                              <span className="token space"> </span>
                              <span className="token space"> </span>
                              "description": "Obat tablet biasanya berupa padatan
                              <span className="token lf">{"\n"}</span>
                              <span className="token space"> </span>
                              <span className="token space"> </span>
                              <span className="token space"> </span>
                              ...
                              <span className="token space"> </span>
                              <span className="token space"> </span>
                              berbentuk bulat atau oval. Jenis medicine ini tersusun 
                              <span className="token lf">{"\n"}</span>
                              <span className="token space"> </span>
                              <span className="token space"> </span>
                              <span className="token space"> </span>
                              ...
                              <span className="token space"> </span>
                              <span className="token space"> </span>
                              atas zat aktif yang dikombinasikan dengan bahan-bahan 
                              <span className="token lf">{"\n"}</span>
                              <span className="token space"> </span>
                              <span className="token space"> </span>
                              <span className="token space"> </span>
                              ...
                              <span className="token space"> </span>
                              <span className="token space"> </span>
                              "description": "Paracetamol adalah medicine untuk meredakan
                              <span className="token lf">{"\n"}</span>
                              <span className="token space"> </span>
                              <span className="token space"> </span>
                              <span className="token space"> </span>
                              ...
                              <span className="token space"> </span>
                              <span className="token space"> </span>
                              demam dan nyeri, termasuk nyeri haid atau sakit gigi.",
                              <span className="token lf">{"\n"}</span>
                              <span className="token space"> </span>
                              <span className="token space"> </span>
                              <span className="token space"> </span>
                              ...
                              <span className="token space"> </span>
                              <span className="token space"> </span>
                              "image": "Paracetamol adalah medicine untuk meredakan 
                              <span className="token lf">{"\n"}</span>
                              <span className="token space"> </span>
                              <span className="token space"> </span>
                              <span className="token space"> </span>
          ...
          <article className="documentation_body" id="api-post-medicine">
            <h4 className="c_head"><span className="badge bg-info ml-1">POST</span>/medicine create medicine</h4>
            <div className="highlight">
              <div className="code-toolbar"><pre className=" language-htmlasc"><code className=" language-htmlasc" data-lang="html">http://103.228.245.122:3033/medicine</code></pre><div className="toolbar"><div className="toolbar-item"><span>Htmlasc</span></div><div className="toolbar-item"><button>Copy</button></div></div></div>
            </div>
            <p>This API for create medicine data and will be showed up on Medicine List, Hit Medicine Category List API and Medicine Unit List API and get their id. After that use the id on your form body request to use this API.</p>
            <table className="table table-bordered">
                    <thead>
                      <tr>
                        <th colspan="2">Parameter</th>
          ...
          <article className="documentation_body" id="api-post-medicine">
          <h4 className="c_head"><span className="badge bg-success ml-1">GET</span>/medicine/(id) detail medicine</h4>
            <div className="highlight">
              <div className="code-toolbar"><pre className=" language-htmlasc"><code className=" language-htmlasc" data-lang="html">http://103.228.245.122:3033/medicine</code></pre><div className="toolbar"><div className="toolbar-item"><span>Htmlasc</span></div><div className="toolbar-item"><button>Copy</button></div></div></div>
            </div>
            <p>This API is used to see detail medicine data by it's id.</p>
            <table className="table table-bordered">
                    <thead>
                      <tr>
                        <th colspan="2">Parameter</th>
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <div>Id of Medicine, get it from Medicine List API to update the information by id</div>
          ...
          <article className="documentation_body" id="api-delete-medicine">
            <h4 className="c_head"><span className="badge bg-danger ml-1">DELETE</span>/medicine/(id) delete medicine</h4>
            <div className="highlight">
              <div className="code-toolbar"><pre className=" language-htmlasc"><code className=" language-htmlasc" data-lang="html">http://103.228.245.122:3033/medicine/2</code></pre><div className="toolbar"><div className="toolbar-item"><span>Htmlasc</span></div><div className="toolbar-item"><button>Copy</button></div></div></div>
            </div>
                      ...
                      <tr>
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>
                              <div>Id of Medicine, get it from Medicine List API to delete this medicine by id</div>
                              <input type="text" class="" title="" placeholder="id" value=""/>
                            </td>
                          </tr>
                        </tbody>
          ...
          <article className="documentation_body" id="api-patch-medicine">
            <h4 className="c_head"><span className="badge bg-info ml-1">PATCH</span>medicine/(id) update medicine</h4>
            <div className="highlight">
              <div className="code-toolbar"><pre className=" language-htmlasc"><code className=" language-htmlasc" data-lang="html">http://103.228.245.122:3033/medicine</code></pre><div className="toolbar"><div className="toolbar-item"><span>Htmlasc</span></div><div className="toolbar-item"><button>Copy</button></div></div></div>
            </div>
            <p>This API for update medicine data and will be replaced old medicine information with your new input, You have to get the id of the data you want to change, Hit Medicine List API to get it.</p>
            <table className="table table-bordered">
                    <thead>
                      <tr>
                        <th colspan="2">Parameter</th>
