  ...
  return (
    ...
    >
      ...
      <article className="documentation_body" id="api-get-medicine">
        ...
        <p>Menampilkan daftar semua obat.</p>
        <table className="table table-bordered">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <div>Untuk menampilkan nama setiap obat yang dibutuhkan</div>
                <input
                  type="text"
                  class=""
                  title=""
            ...
            <tr>
              ...
              <td>
                <div>untuk menampilkan harga obat awal mulai - Default: 0</div>
                <input
                  type="text"
                  class=""
                  title=""
            ...
            <tr>
              ...
              <td>
                <div>untuk menampilkan harga obat akhir - Default: 1000000000 </div>
                <input
                  type="text"
                  class=""
                  title=""
            ...
            <tr>
              ...
              <td>
                <div>menampilkan ID obat sesuai kategori</div>
                <input
                  type="text"
                  class=""
                  title=""
            ...
            <tr>
              ...
              <td>
                <div>menampilkan ID unit obat sesuai kebutuhan</div>
                <input
                  type="text"
                  class=""
                  title=""
      ...
      <article className="documentation_body" id="api-post-medicine">
        ...
        <p>
        API ini untuk membuat data obat dan akan muncul di Medicine List, Hit Medicine Category List API dan Medicine Unit List API dan mendapatkan id mereka. Setelah itu gunakan id pada permintaan isi formulir Anda untuk menggunakan API ini.</p>
        <table className="table table-bordered">
          <thead>
            <tr>
              <th colspan="2">Parameter</th>
          ...
          <tbody>
            <tr>
              ...
              <td>
                <div>untuk menampilkan deskripsi muatan obat yang dibutuhkan </div>
      ...
      <article className="documentation_body" id="api-get-detail-medicine">
        ...
        <p>
        API ini digunakan untuk melihat data obat detail berdasarkan id-nya.
        </p>
        <table className="table table-bordered">
          <thead>
            <tr>
          ...
          <tbody>
            <tr>
              ...
              <td>
                <div>
                  Id  Obat, didapatkan dari data list obat untuk memperbaharui informasi dengan memasukkan ID
                </div>
                <input
                  type="text"
                  class=""
      ...
      >
        ...
        <p>API ini untuk menghapus data obat dengan id-nya.</p>
        <table className="table table-bordered">
          <thead>
            <tr>
              <th colspan="2">Parameter</th>
          ...
          <tbody>
            <tr>
              ...
              <td>
                <div>
                Id  Obat, didapatkan dari data list obat untuk menghapus data obat dengan memasukkan ID
                </div>
                <input
                  type="text"
                  class=""
      ...
      <article className="documentation_body" id="api-patch-medicine">
        ...
        <p>
        API ini untuk update data obat dan akan diganti informasi obat lama dengan input baru anda, Anda harus mendapatkan id dari data yang ingin anda ubah, Tekan Medicine List API untuk mendapatkannya.
        </p>
        <table className="table table-bordered">
          <thead>
            <tr>
